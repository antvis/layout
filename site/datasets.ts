...
export const loadDatasets = async (dimensions = 2) => {
  ...
  const loadRandomClusters = (NODES: number, EDGES: number) => {
    ...
    return {
      ...
      [TestName.ANTV_LAYOUT_WEBGL]: antvgraph,
      [TestName.ANTV_LAYOUT_WEBGPU]: antvgraph,
  ...
  const loadG6JSON = (url: string, desc: string) => {
    return async () => {
      ...
      return {
        ...
        [TestName.ANTV_LAYOUT_WEBGL]: antvGraphModel,
        [TestName.ANTV_LAYOUT_WEBGPU]: antvGraphModel,
